  ...
  return (
    <div className="grid md:grid-cols-2 md:max-h-[400px] gap-5 mb-10">
      ...
      <div className="flex justify-center">
        {movie.backdrop_path ? (<img src={baseImageURL + movie.backdrop_path} alt={movie.title} className="drop-shadow-[0_0_80px_rgba(255,255,255,0.4)] my-4 rounded object-contain max-h-[300px]"/>) : (
          <div className="drop-shadow-[0_0_80px_rgba(255,255,255,0.4)] my-4 rounded object-contain max-h-[300px] bg-zinc-500 min-h-[200px] h-full w-full  grid place-items-center">
